...
A [timoni.sh](http://timoni.sh) module for deploying [seerr](https://docs.seerr.dev/) to Kubernetes clusters.
...
```shell
timoni -n default apply seerr oci://philipsd6/timoni-seerr
```
...
```shell
timoni -n default apply seerr oci://philipsd6/timoni-seerr --values ./my-values.cue
```
...
| `image: repository:`                 | `string`                         | `docker.io/seerr` | Container image repository                                              |
