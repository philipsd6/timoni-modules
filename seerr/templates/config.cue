...
#Config: {
	...
	image: timoniv1.#Image & {
		repository: *"ghcr.io/seerr-team/seerr" | string
		tag:        *"latest" | string
		digest:     *"" | string
	}
	...
	securityContext: corev1.#SecurityContext & {
		...
		runAsUser: *1000 | int
		runAsGroup: *1000 | int
		seccompProfile: type: *RuntimeDefault | corev1.#enumSeccompProfileType
	}

	podSecurityContext: corev1.#podSecurityContext & {
		fsGroup: *1000 | int
		fsGroupChangePolicy: *OnRootMismatch | corev1.#enumPodFSGroupChangePolicy
	}
