...
A [timoni.sh](http://timoni.sh) module for deploying booklore to Kubernetes clusters.
...
```shell
timoni -n default apply booklore oci://philipsd6/timoni-booklore
```
...
```shell
timoni -n default apply booklore oci://philipsd6/timoni-booklore --values ./my-values.cue
```
...
```shell
timoni -n default delete booklore
```
...
| `image: repository:`                 | `string`                         | `docker.io/booklore` | Container image repository                                              |
