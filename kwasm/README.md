...
A [timoni.sh](http://timoni.sh) module for deploying kwasm to Kubernetes clusters.
...
```shell
timoni -n default apply kwasm oci://philipsd6/timoni-kwasm
```
...
```shell
timoni -n default apply kwasm oci://philipsd6/timoni-kwasm --values ./my-values.cue
```
...
| `image: repository:`                 | `string`                         | `docker.io/kwasm` | Container image repository                                              |
