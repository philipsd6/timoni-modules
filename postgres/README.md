...
A [timoni.sh](http://timoni.sh) module for deploying postgres to Kubernetes clusters.
...
```shell
timoni -n default apply postgres oci://<container-registry-url>
```
...
```shell
timoni -n default delete postgres
```
