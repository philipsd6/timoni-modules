...
| `database: enabled:`         | `bool`                           | `true`                                      | A PostgreSQL database is required                                  |
| `database: host:`            | `string`                         | `""`                                        | The hostname for the PostgreSQL server                             |
| `database: port:`            | `int`                            | `5432`                                      | The PostgreSQL port                                                |
| `database: superuser:`       | `bool`                           | `true`                                      | Admin access is required for application initialization            |
| `database: name:`            | `string`                         | `teslamate`                                 | The database name                                                  |
| `database: user:`            | `string`                         | `teslamate`                                 | The database user                                                  |
| `database: password:`        | `string`                         | `teslamate`                                 | The database password (default should be overridden)               |
| `database: encryptionKey:`   | `string`                         | `teslamate`                                 | The key used to encrypt Tesla credentials                          |
...
| `bitwarden: variables:`      | `[...string]`                    | `[DATABASE_NAME/USER/PASS, ENCRYPTION_KEY]` | The environment variables to get from the item                     |
...
- `DATABASE_PASS`
- `ENCRYPTION_KEY`
If you don't use the Bitwarden external secret feature, then you should ensure the `database: name|user|password|encryptionKey` values are injected at runtime safely.
