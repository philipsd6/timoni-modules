...
```shell
timoni -n default apply blueprint oci://philipsd6/timoni-blueprint
```
...
```shell
timoni -n default apply blueprint oci://philipsd6/timoni-blueprint --values ./my-values.cue
```
...
| `image: repository:`                 | `string`                         | `docker.io/blueprint` | Container image repository                                              |
