...
A [timoni.sh](http://timoni.sh) module for deploying calibre-web-automated to Kubernetes clusters.
...
```shell
timoni -n default apply calibre-web-automated oci://ghcr.io/philipsd6/timoni-calibre-web-automated:latest
```
...
```shell
timoni -n default delete calibre-web-automated
```
...
| `image: repository:`          | `string`                         | `ghcr.io/crocodilestick/calibre-web-automated-automated` | Container image repository                                |
