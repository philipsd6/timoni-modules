...
A [timoni.sh](http://timoni.sh) module for deploying mainsail to Kubernetes clusters.
...
```shell
timoni -n default apply mainsail oci://philipsd6/timoni-mainsail
```
...
```shell
timoni -n default apply mainsail oci://philipsd6/timoni-mainsail --values ./my-values.cue
```
...
```shell
timoni -n default delete mainsail
```
...
| `image: repository:`                 | `string`                         | `docker.io/mainsail` | Container image repository                                              |
