...
A [timoni.sh](http://timoni.sh) module for deploying agregarr to Kubernetes clusters.
...
```shell
timoni -n default apply agregarr oci://philipsd6/timoni-agregarr
```
...
```shell
timoni -n default apply agregarr oci://philipsd6/timoni-agregarr --values ./my-values.cue
```
...
```shell
timoni -n default delete agregarr
```
...
| `image: repository:`                 | `string`                         | `docker.io/agregarr` | Container image repository                                              |
