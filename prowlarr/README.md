...
A [timoni.sh](http://timoni.sh) module for deploying prowlarr to Kubernetes clusters.
...
```shell
timoni -n default apply prowlarr oci://ghcr.io/philipsd6/timoni-prowlarr:latest
```
...
```shell
timoni -n default delete prowlarr
```
...
| `image: repository:`     | `string`                         | `ghcr.io/hotio/prowlarr` | Container image repository                                |
...
| `persistence: [config]`  | `{}`                             | `{}`                     | Customize the persistence for mountpoints                 |
| `enabled`                | `bool`                           | `false`                  | Enable this mountpoint                                    |
| `mountPath`              | `string`                         | `/config` \| `/config`   | Where to mount inside the container                       |
