...
A [timoni.sh](http://timoni.sh) module for deploying [shelfmark](https://github.com/calibrain/shelfmark) to Kubernetes clusters.
...
```shell
timoni -n default apply shelfmark oci://ghcr.io/philipsd6/timoni-shelfmark:latest
```
...
```shell
timoni -n default delete shelfmark
```
...
| `image: repository:`          | `string`                         | `ghcr.io/calibrain/shelfmark` | Container image repository                                |
